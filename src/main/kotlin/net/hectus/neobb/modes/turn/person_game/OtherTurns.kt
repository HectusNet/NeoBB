...
class PTPainting(data: Painting?, cord: Cord?, player: NeoPlayer?) : OtherTurn<Painting>(data, cord, player), BuffCategory {
    ...
    override fun apply() {
        ...
        when (data!!.art) {
            Art.ALBAN -> Luck(30).invoke(player)
