...
public class PTIronTrapdoor extends BlockTurn implements CounterCategory {
    public PTIronTrapdoor(NeoPlayer player) { super(player); }
    public PTIronTrapdoor(Block data, NeoPlayer player) { super(data, player); }
