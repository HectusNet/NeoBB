...
public class THornCoral extends BlockTurn implements CounterattackFunction, WaterClazz {
    public THornCoral(NeoPlayer player) { super(player); }
    public THornCoral(Block data, NeoPlayer player) { super(data, player); }
