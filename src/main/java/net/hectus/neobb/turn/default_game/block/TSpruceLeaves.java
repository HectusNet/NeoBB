...
public class TSpruceLeaves extends BlockTurn implements CounterattackFunction, ColdClazz {
    public TSpruceLeaves(NeoPlayer player) { super(player); }
    public TSpruceLeaves(Block data, NeoPlayer player) { super(data, player); }
